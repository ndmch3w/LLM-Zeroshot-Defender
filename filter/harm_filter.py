...
class HarmFilter:
    ...
    def harm_filter_function(self, responses_csv_path, results_path ,model_name ):
        ...
        if model_name =="llama":
            tokenizer_llama = LlamaTokenizer.from_pretrained("NousResearch/Llama-2-7b-hf")
            model_llama = LlamaForCausalLM.from_pretrained("NousResearch/Llama-2-7b-hf")
...
if __name__ == "__main__":
    ...
    DATA_PATH = "all_repsonses_gpt.csv"
